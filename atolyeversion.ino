//Auduino, the Lo-Fi granular synthesizer
//
//by Peter Knight, Tinker.it http://tinker.it
//by Pechblenda of Calafou, pechblenda.hotglue.me
//A product of AtolyeWare for AtolyeCore and you lazy bastards
//
...
#define Synch_Control (5)
#define GRAIN_FREQ_CONTROL (0)
#define GRAIN_DECAY_CONTROL (2)
#define GRAIN2_FREQ_CONTROL (3)
#define GRAIN2+_DECAY_CONTROL (1)

//Changing these will also requires rewriting audioOn()

//This program is just for modern ATmega168 or ATmega328 boards
//Output is on pin 4
//
#define PWM_PIN 4
...
void loop(){
  ...
  grain2Decay = analogRead(GRAIN2_DECAY_CONTR
}
